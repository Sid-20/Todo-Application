...
<body>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="goHome">HOME</a></li>
...
<div class="container">
  ...
  <br><br>
  <form class="form-horizontal" action="deleteTaskNumber" method="get">
    <div class="form-group">
      <label class="control-label col-sm-2" style="margin-left:20%">Enter Task Number:</label>
      <div class="col-sm-4">
